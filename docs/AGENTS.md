# AI Agent Registry & Roles

This file tracks the active agents and their specific areas of focus.

| Agent Name                              | Role                 | Focus Area                                                  | Status |
| :-------------------------------------- | :------------------- | :---------------------------------------------------------- | :----- |
...
1. **Check CURRENT_TASK.md** before starting work.
2. **Update PROGRESS.md** after every significant milestone.
3. **Log architectural choices** in **DECISIONS.md**.
4. **Update PLAN.md** if the roadmap changes and if the task is done mark it complete
   .
